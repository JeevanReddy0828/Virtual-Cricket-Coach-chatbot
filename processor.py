...
def predict_class(sentence, model):
    ...
    # sorted by strength of probability
...
def chatbot_response(msg):
    # Checking if it's a training-related query
    if "training" in msg.lower() or "plan" in msg.lower():
        return generate_training_plan(msg)
